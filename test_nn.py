...
def sgd_test():
    ...
    all_batches, all_labels = train_sets[3]
    for lr in learning_rate:
        ...
        for e in range(epochs):
            ...
            accs_hyper_params_test.append(np.mean(test_accuracy(softmax, test_sets[3])))
        ...
        plt.title('Acc of lr={} and batch size={}'.format(lr, 16))
        plt.legend()
        plt.show()
